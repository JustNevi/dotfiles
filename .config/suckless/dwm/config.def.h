...
/* commands */
#define LOCAL_ENV_BIN "~/.local/bin/env"
...
static const Key keys[] = {
	...
	{ 0,XF86XK_AudioMute,			spawn,           SHCMD(LOCAL_ENV_BIN "/hotkeys/hk-volume mute toggle") },
	{ 0,XF86XK_AudioLowerVolume,	spawn,           SHCMD(LOCAL_ENV_BIN "/hotkeys/hk-volume dic") },
	{ 0,XF86XK_AudioRaiseVolume,	spawn,           SHCMD(LOCAL_ENV_BIN "/hotkeys/hk-volume inc") },
	{ 0,XF86XK_AudioMicMute,		spawn,           SHCMD(LOCAL_ENV_BIN "/hotkeys/hk-microphone mute toggle") },
	{ ShiftMask,XF86XK_AudioLowerVolume,		spawn,           SHCMD(LOCAL_ENV_BIN "/hotkeys/hk-microphone dic") },
	{ ShiftMask,XF86XK_AudioRaiseVolume,		spawn,           SHCMD(LOCAL_ENV_BIN "/hotkeys/hk-microphone inc") },
	{ 0,XF86XK_MonBrightnessDown,	spawn,           SHCMD(LOCAL_ENV_BIN "/hotkeys/hk-brightness dic") },
	{ 0,XF86XK_MonBrightnessUp,		spawn,           SHCMD(LOCAL_ENV_BIN "/hotkeys/hk-brightness inc") },
	{ ShiftMask,	XK_Alt_L,		spawn,           SHCMD(LOCAL_ENV_BIN "/hotkeys/hk-keyboard") },
};
